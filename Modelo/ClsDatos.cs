   ...
   public class ClsDatos
    {
        ...
        public ClsDatos(){
            strCadenaConexion = @"Data Source=SALA403-13\SQLEXPRESS;Initial Catalog=Contacto;Integrated Security=True";
        ...
        public DataTable RetornaTabla(SqlParameter[] parParametros, string parTSQL) {
            ...
            try
            {
                ...
                cmdComando.Connection = cnnConexion; cmdComando.CommandType = CommandType.StoredProcedure;
